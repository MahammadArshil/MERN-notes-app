...
const Home = () => {
    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            ...
            <div className="px-4 pt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {filteredNote.length > 0 ? (
                    filteredNote.map((note) => <NoteCard key={note._id} note={note} onEdit={onEdit} deleteNote={deleteNote} />)
                ) : (
